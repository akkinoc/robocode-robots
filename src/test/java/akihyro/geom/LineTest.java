...
public class LineTest {
    ...
    public void getDistance_距離を取得できる() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() + 1.0, from.getY() + sqrt(3.0));
        Line line = new Line(from, to);
     ...
     */
    @Test
    public void getDistance_終点が始点より左側にある場合でも正数を返す() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() - 1.0, from.getY() + sqrt(3.0));
        Line line = new Line(from, to);
        assertThat(line.getDistance(), closeTo(2.0, NEAR_DELTA));
     ...
     */
    @Test
    public void getDistance_終点が始点より下側にある場合でも正数を返す() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() + 1.0, from.getY() - sqrt(3.0));
        Line line = new Line(from, to);
        assertThat(line.getDistance(), closeTo(2.0, NEAR_DELTA));
     ...
     */
    @Test
    public void getDistance_終点が始点より左下側にある場合でも正数を返す() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() - 1.0, from.getY() - sqrt(3.0));
        Line line = new Line(from, to);
        assertThat(line.getDistance(), closeTo(2.0, NEAR_DELTA));
    ...
    public void getDistance_始点と終点が同一の場合は0を返す() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX(), from.getY());
        Line line = new Line(from, to);
     ...
     */
    @Test
    public void getAngle_終点が始点より左側にある場合は負数を返す() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() - 1.0, from.getY() + sqrt(3.0));
        Line line = new Line(from, to);
        assertThat(line.getAngle(), closeTo(- PI / 6.0, NEAR_DELTA));
     ...
     */
    @Test
    public void getAngle_終点が始点より下側にある場合はPIの半分を上回る() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() + 1.0, from.getY() - sqrt(3.0));
        Line line = new Line(from, to);
     ...
     */
    @Test
    public void getAngle_終点が始点より左下側にある場合はマイナスPIの半分を下回る() {
        Point from = new Point(1.2, 3.4);
        Point to = new Point(from.getX() - 1.0, from.getY() - sqrt(3.0));
        Line line = new Line(from, to);
        assertThat(line.getAngle(), closeTo(- PI + PI / 6.0, NEAR_DELTA));
